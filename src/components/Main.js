          ...
          <div className="main-page contents container">
            ...
            <div className="introduce">
              ...
              <div className="centerAlignedContainer" style={centerAlignedContainer} >
                <div className="leftAlignedHeader" style={leftAlignedHeader}  data-aos={"fade-down"}>
                  <b style={{fontSize:'100px'}}>NPC</b>                    
                  <br/>
                  <b style={{fontSize:'50px'}}>NP-Complete</b>
                </div>
                <div className="centerBlock" style={centerBlock}></div>
                <div className="rightAlignedHeader" style={rightAlignedHeader}  data-aos={"fade-down"}>
              ...
              <div className="centerAlignedContainer" style={centerAlignedContainer}>
                <div className="leftAlignedContentsHeader" style={leftAlignedContentHeader}>
                  <b>NPC는<br/>알고리즘 문제해결(PS) 동아리입니다.</b>
                </div>
                ...
                <img src={cppimage} alt="cppimage" style={ cppImageStyle }  data-aos={"fade-down"}/>
              </div>
              <div className="centerAlignedContainer" style={centerAlignedContainer}>
                <div className="leftAlignedContentsHeader" style={leftAlignedContentHeader}>
                  <b>
                ...
                <img src={image24} alt="floorInformation"  data-aos={"flip-down"} ></img>
            ...
            <div className="apply" >
              ...
              (<span style={{color:"#FFFFFF"}}>interested</span>)<br/>
              <span style={{color:"#F6E437"}}>&emsp;&emsp;&emsp;join</span>
              (<span style={{color:"#B2ED70"}}>NPC</span>)<br/><br/>
